...
enum {
  ...
  BORAX_WIDETAG_BUILT_IN_CONSTANT = 0x13,
...
enum {
  ...
  BORAX_DISCRIM_BUILT_IN_CONSTANT = BORAX_WIDETAG_BUILT_IN_CONSTANT,
...
extern CONST BORAX_GC_HOOKS  gBuiltInConstantGcHooks;
