...
enum {
  ...
  BORAX_IMMEDIATE_NIL             = 0x08 | BORAX_LOWTAG_OTHER_IMMEDIATE,
  BORAX_IMMEDIATE_T               = 0x10 | BORAX_LOWTAG_OTHER_IMMEDIATE,
...
#define BORAX_BOUNDP(_obj) \
(!BORAX_EQ((_obj), BORAX_UNBOUND))

#define BORAX_NIL  ((BORAX_OBJECT) {BORAX_IMMEDIATE_NIL})
#define BORAX_T    ((BORAX_OBJECT) {BORAX_IMMEDIATE_T})

#define BORAX_BOOL(_obj) \
(!BORAX_EQ((_obj), BORAX_NIL))
...
enum {
  ...
  BORAX_WIDETAG_EXIT              = 0x1B,
  BORAX_WIDETAG_INTERPRETER       = 0xEB,
...
enum {
  ...
  BORAX_DISCRIM_T         = BORAX_IMMEDIATE_T,
  ...
  BORAX_DISCRIM_EXIT              = BORAX_WIDETAG_EXIT,
  BORAX_DISCRIM_INTERPRETER       = BORAX_WIDETAG_INTERPRETER,
...
extern CONST BORAX_GC_HOOKS  gExitGcHooks;
extern CONST BORAX_GC_HOOKS  gInterpreterGcHooks;
